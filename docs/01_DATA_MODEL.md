...
| | `receipt.template` — the Scriban body the sale receipt renders through (P1-T11, FR-7.3, NFR-M1); ships as the §10.1 specimen (`Application/Settings/ReceiptTemplateDefaults.cs`), owner-editable with no rebuild | `STRING` |
