...
namespace Counterpoint.Infrastructure.Migrations
{
    ...
    [Migration("20260925020216_ExchangeTenderType0010")]
    partial class ExchangeTenderType0010
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("payment", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_payment_tender_type", "tender_type IN ('CASH','CARD','BANK_TRANSFER','CREDIT_NOTE','ON_ACCOUNT','CHEQUE','EXCHANGE')");
                        });
                });
            ...
            modelBuilder.Entity("Counterpoint.Infrastructure.Data.Schema.StockTake", b =>
                {
                    ...
                    b.HasIndex("StockTakeNo")
                        .IsUnique()
                        .HasDatabaseName("ux_stock_take_no");
            ...
            modelBuilder.Entity("Counterpoint.Infrastructure.Data.Schema.Payment", b =>
                {
                    ...
                    b.HasOne("Counterpoint.Infrastructure.Data.Schema.SaleReturn", null)
                        ...
                        .HasForeignKey("SaleReturnId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_payment_sale_return_sale_return_id");
                });
