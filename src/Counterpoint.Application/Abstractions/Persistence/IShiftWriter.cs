...
/// <summary>
/// Writes <c>shift</c> - append-only apart from the close fields (CLAUDE.md invariant 5,
/// docs/01_DATA_MODEL.md §7).
/// </summary>
/// <remarks>
...
/// fields, settable once), and it belongs to <see cref="IShiftCloseWriter"/> instead (task
/// P3-T03), not this port.
/// </remarks>
