...
1. **Is it out of scope?** `docs/Hardware_Shop_POS_Requirements.md` section 5 excludes multi-terminal, e-commerce, accounting integration, loyalty, job costing, live cloud dashboards and mobile apps. If the request is one of these, say so plainly with the consequence, and do not quietly design around it.
